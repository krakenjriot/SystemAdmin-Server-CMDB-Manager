...
<div class="form-wrapper">
  ...
  <label><h4><b>Other Details</b> (<?php echo strtoupper($fqdn); ?>)</h4></label>
    <div class="form-group">
      ...
      <input id="first" class="form-input" type="text" name="BU" value="<?php echo $BU; ?>"/>
    </div>
    <div class="form-group">
      <label class="form-label" for="last" id="PRIORITY">PRIORITY</label>
      <input id="last" class="form-input" type="text" name="PRIORITY" value="<?php echo $PRIORITY; ?>"/>
    </div>

    <div class="form-group">
      <label class="form-label" for="last" id="SEVERITY">SEVERITY</label>
      <input id="last" class="form-input" type="text" name="SEVERITY" value="<?php echo $SEVERITY; ?>"/>
    </div>	
	<!--
    <div class="form-group">
