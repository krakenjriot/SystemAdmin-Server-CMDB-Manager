  ...
  <body>
    ...
    <main role="main" class="container">
			...
			?>
				...
				<!-------------------------------------------------------------------------------------------------------------------->
				<?php if($verified == 1){ 	?> 
				<form class="form-signin" action="verify_reset_link_process.php?email=<?php echo $email; ?>" method="post" >
					...
					<input type="password" name="pass1" id="inputPassword" class="form-control" placeholder="Old Password" required autofocus>
